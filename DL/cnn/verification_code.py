...
if __name__ == '__main__':
    ...
    # TODO: 作业，假定这个模型运行一段时间后，可以顺利的保存模型；那么自己加入一些代码，代码功能：使用保存好的模型对验证码做一个预测，最终返回值为验证码上的具体字符串；
    # TODO: 作业，车牌照的识别，分成两个过程：1. 从车辆图片中提取出车牌照区域的值，然后2.对车牌照图片做一个预测； 简化：认为车牌只有蓝牌
