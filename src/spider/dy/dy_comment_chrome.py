            ...
            try:
                ...
                try:
                    id = driver.find_element(by=By.XPATH,
                                             value="//*[@id='root']/div/div[2]/div/div/div[2]/div[1]/p[1]/span[1]").text.split(
                        '：')[1].strip()
                except:
                    id = ""
                # 关注
                ...
                try:
                    ip_address = driver.find_element(by=By.XPATH,
                                                     value="//*[@id='root']/div/div[2]/div/div/div[2]/div[1]/p[1]/span[2]").text.split(
                        '：')[1].strip()
                except:
                    ip_address = ""
...
if __name__ == "__main__":
    ...
    data = pd.DataFrame({"userId": userId, "userName": userNames, "userAddress": userAddress, "userFan": userFan,
                         "userFollow": userFollow, "userLiked": userLiked, "date": timeList, "comments": comments,
                         "likeNuns": likeNums})
