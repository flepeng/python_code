...
def get_header():
    phone_agent_list = [
        ...
        # "NOKIA5700/ UCWEB7.0.2.37/28/999",  # UC标准
        "Openwave/ UCWEB7.0.2.37/28/999",  # UC Openwave
    ...
    user_agent_list = [
        ...
        "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1)",  # IE 6.0
